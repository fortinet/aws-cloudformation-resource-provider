...
public class CreateHandler extends BaseHandler<CallbackContext> {
    ...
    public ProgressEvent<ResourceModel, CallbackContext> handleRequest(final AmazonWebServicesClientProxy proxy,
        ...
        String payload = "{" +
                "\"name\":" + "\"" + model.getName() + "\"" + "," + "\"mode\":" + "\"" + model.getMode() + "\"" + ","
                + "\"vdom\":" + "\"" + model.getVdom() + "\"" + "," + "\"type\":" + "\"" + model.getType() + "\"" + ","
                + "\"role\":" + "\"" + model.getRole() + "\"" + "," +
                "\"allowaccess\":" + "\"" + model.getAllowaccess() + "\"" + "," + "\"vlanid\":" + model.getVlanid()
                + "," + "\"interface\":" + "\"" + model.getInterface_() + "\"" + "}";

        String bearerToken = model.getAPIKey();
        String requestUrl = "https://" + model.getFortigateIP() + "/api/v2/cmdb/system/interface";
